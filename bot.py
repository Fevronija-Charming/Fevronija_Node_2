...
@dp.message(or_f((F.text=="_Восьмиугольник_"),(F.text=="_Квадрат_"),(F.text=="_Ромб_"),(F.text()=="_Круг_")))
...
#async def kostily_BD(bot:Bot):
    # создать ДБ
    #import psycopg2 as ps
    #from psycopg2.errors import DublicateDatabase as Oshibka
    ...
    #try:
        ...
        #print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
        # bot.send_message(chat_id=os.getenv('MYUSERID'), text='БД уже есть, моя Госпожа!!!')
